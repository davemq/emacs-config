...
\"#######..#\" };")))
 ...
 '(erc-modules
   (quote
    (autojoin button completion irccontrols list match menu move-to-prompt netsplit networks noncommands readonly ring services stamp track highlight-nicknames)))
 '(erc-networks-alist
   (quote
    ((4-irc "4-irc.com")
     (A5KNet "a5knet.com")
 ...
 '(gnus-message-archive-method
   (quote
    (nnimap "imap.linux.ibm.com"
	    (nnimap-stream ssl)
	    (nnimap-authenticator login))))
 '(gnus-posting-styles
   (quote
    ((".*"
      (address "davemarq@linux.vnet.ibm.com")
      (eval
       (setq smtp-mail-server "na.relay.ibm.com" smtp-mail-service 25 gnus-message-archive-group "Sent")))
     ("nnimap\\+gmail:.*"
      (address "dave.marquardt.tx@gmail.com")
      (eval
       (setq smtp-mail-server "smtp.gmail.com" smtp-mail-service 465 gnus-message-archive-group "nnimap+gmail:[Gmail]/Sent Mail")))
     ("nnimap\\+daverrtx:.*"
      (address "daverrtx@gmail.com")
      (eval
       (setq smtp-mail-server "smtp.gmail.com" smtp-mail-server 465 gnus-message-archive-group "nnimap+daverrtx:[Gmail]/Sent Mail"))))))
 '(gnus-select-method
   (quote
    (nnimap "imap.linux.ibm.com"
	    (nnimap-stream ssl)
 ...
 '(gnus-simplify-subject-fuzzy-regexp
   (quote
    ("The defect is now in Verify: " "defect Note Modified: " "Defect/Feature Closed: " "Defect " "Comment: " "Returned as Dup: " "Returned: " "Assigned: " "Reopened: " "Opened: " "Modified: " "Accepted: " " by .*" ", sev [1-5]" "Canceled: " "Verification Record For " "Marked")))
 ...
 '(ldap-host-parameters-alist
   (quote
    (("bluepages.ibm.com" base "ou=bluepages,o=ibm.com" auth simple scope subtree))))
 '(linum-format " %7i ")
 ...
 '(org-agenda-files
   (quote
    ("~/org/aix.org" "~/org/ibm.org" "~/pers/personal.org")))
